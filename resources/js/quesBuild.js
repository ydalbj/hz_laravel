...
var submiit = '';
submiit += ' <form class="mui-card " style="display: none"> <div class="mui-card-header mui-card-media" style="height:35vw;background-image:url(../img/b1.jpg)"></div> <div class="mui-card-content"> <div class="mui-card-content-inner"> <p>尊敬的健康管理客户：</p> <p style="color: #333;"> 您好:<br/>欢迎您体验健康管理服务。在对您提供个性化的健康管理服务之前，需要充分了解您的疾病史和日常生活习惯，以期了解您目前的健康状况，并评估可能存在的健康风险。健康管理师将根据主要疾病的风险评估报告制定健康促进计划，帮助您建立起更加健康的生活方式.我们充分尊重个人信息的隐私保护，任何个人或机构未经您的许可或授权，均不能获得您任何个人信息。请您认真、完整回答以下每个问题。画□的为多选题，画○的为单选题。感谢您的合作！</p> </div> </div> <div class="mui-card-footer"> <a class="mui-card-link prevQuestion">上一页</a> <button id="confirmBtn" type="button" class="mui-btn mui-btn-primary">完成提交</button> <a class="mui-card-link turnToIndex ">首页</a> </div> </form>';
